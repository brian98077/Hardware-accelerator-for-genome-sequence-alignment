...
int main(){
    ...
    for(int j=0;j<NUMBER;j++){
        ...
        cout << "----------start----------" << endl;
        cout << "data " << j + 1 << ": " << endl;
        cout << "score of SW: " << SetColor(11) << answer[j].score << SetColor(7) << endl;
        // cout << "R: ";
        ...
        cout << "score of BSW: " << SetColor(11) << answer_BSW[j].score << SetColor(7) << endl;
        // cout << "R: ";
        ...
        cout << "score of GACT-X: " << SetColor(11) << answer_GACT_X[j].score << SetColor(7) << endl;
        // cout << "R: ";
    ...
    cout << endl;
    cout << "---------SUMMARY----------" << endl;
    cout << "BSW bandwidth:     " << setw(3) << SetColor(11) << bandwidth << SetColor(7) << endl;
    cout << "BSW perfect:       " << setw(3) << SetColor(11) << BSW_perfect << SetColor(7) << "/" << NUMBER << endl;
    cout << "BSW good:          " << setw(3) << SetColor(11) << BSW_good << SetColor(7) << "/" << NUMBER << endl;
    cout << "GACT-X parameter:  " << setw(3) << SetColor(11) << X << SetColor(7) << endl;
    cout << "GACT-X perfect:    " << setw(3) << SetColor(11) << GACT_X_perfect << SetColor(7) << "/" << NUMBER << endl;
    cout << "GACT-X good:       " << setw(3) << SetColor(11) << GACT_X_good << SetColor(7) << "/" << NUMBER << endl;
